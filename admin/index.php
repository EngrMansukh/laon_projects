...
$userquery = "SELECT COUNT(id) AS user_count FROM users WHERE user_role = 1 AND is_active != 0";
...
$deposite_amount = "SELECT SUM(deposite) as total_deposit FROM loan WHERE is_active   =1";
...
<div class="col-xl-3 col-md-6">
                        <div class="card">
                            <div class="p-5">
                                ...
                                <h6 class="text-muted text-sm uppercase">Total User</h6>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card">
                            <div class="p-5">
                                <i class="bx bx-layer float-right text-3xl text-muted"></i>
                                <h6 class="text-muted text-sm uppercase">Total Deposit Amount</h6>
                                <h3 class="text-2xl mb-3" data-plugin="counterup">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card">
                            <div class="p-5">
                                <i class="bx bx-layer float-right text-3xl text-muted"></i>
                                <h6 class="text-muted text-sm uppercase">Total Withdraw </h6>
                                <h3 class="text-2xl mb-3" data-plugin="counterup">
                                
                                <?= $withdraw_amount_query ?></h3>
