            ...
            <div data-simplebar>
                <ul class="menu" data-fc-type="accordion">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="sub-menu hidden">
                            <li class="menu-item">
                                <a href="loanList.php" class="menu-link">
                                    <span class="menu-dot"></span>
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0)" data-fc-type="collapse" class="menu-link waves-effect">
                            <span class="menu-icon"><i class="ph-duotone ph-money"></i></span>
                            <span class="menu-text"> Withdraw Loan </span>
                            <span class="menu-arrow"></span>
                        </a>

                        <ul class="sub-menu hidden">
                            <li class="menu-item">
                                <a href="withdrawList.php" class="menu-link">
                                    <span class="menu-dot"></span>
                                    <span class="menu-text">Withdraw List</span>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="addWithdraw.php" class="menu-link">
                                    <span class="menu-dot"></span>
                                    <span class="menu-text">Add WithDraw </span>
                                </a>
                            </li>
